...
import { articleWorkAction } from '../State/actions'
          ...
          <div className="row">
            <div className="col-lg-8 col-md-12 col-sm-12">
              <div className="_job_detail_box">
                <h3 className="text-capitalize">{slug} Article Job</h3>
                <div className="_job_detail_single mt-3 ">
                  <h4>Job Summary</h4>
                  <p>
                    Choose from the list of our provide artcles to be written
                    according to different conpany demands. Choose from the list
                    of articles.
                  </p>
                </div>
